...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" routerLink="/dashboard">
      <img src="static/img/logophamduong.png" alt="" class="img-fluid">
    </a>
    <li class="nav-item active">
      <a class="nav-link" routerLink="/dashboard/staff">
    ...
    <!-- Nav Item - Tables -->
    <li class="nav-item">
      <a class="nav-link" routerLink="/dashboard/services">
        <i class="fas fa-user-circle"></i>
    ...
    <li class="nav-item">
      <a class="nav-link" href="#">
        ...
        <span>Quản lý lịch khám</span></a>
    </li>
    <li class="nav-item">
      <a class="nav-link" routerLink="/dashboard/work">
        <i class="fas fa-calendar"></i>
        <span>Quản lý lịch làm việc</span></a>
    </li>
    <li class="nav-item">
      <a class="nav-link" routerLink="/dashboard/customer">
        <i class="fas fa-user-circle"></i>
        <span>Quản lý khách hàng</span></a>
    </li>
    <li class="nav-item">
      <a class="nav-link" routerLink="/dashboard/price">
        <i class="fas fa-user-circle"></i>
        <span>Quản lý giá</span></a>
    </li>
    <li class="nav-item">
      <a class="nav-link" routerLink="/dashboard/work-list">
        <i class="fas fa-user-circle"></i>
        <span>Lịch làm việc</span></a>
    </li><li class="nav-item">
    <a class="nav-link" href="customer-list.html">
      <i class="fas fa-user-circle"></i>
      <span>Đăng ký lịch khám chữa bệnh</span></a>
  </li>
